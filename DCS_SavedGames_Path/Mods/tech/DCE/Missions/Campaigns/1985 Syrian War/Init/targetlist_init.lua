...
targetlist = {   
	...
	["red"] = {		
		...
		["Silifke-Incirlik Supply Line 1-2"] =  { 
			task = "Strike",
			priority = 6,
			picture = {"Silifke-Incirlik_Supply_Line_1-2"},
			attributes = {"Structure"},
			firepower = {
				min = 4,
				max = 8,
		...
		["Silifke-Incirlik Supply Line 3-4"] =  { 
			task = "Strike",
			priority = 6,
			picture = {"Silifke-Incirlik_Supply_Line_3-4"},
			attributes = {"Structure"},
			firepower = {
				min = 4,
				max = 8,
		...
		["Silifke-Incirlik Supply Line 5-6-7"] =  { 
			task = "Strike",
			priority = 6,
			picture = {"Silifke-Incirlik_Supply_Line_5-6-7"},
			attributes = {"Structure"},
			firepower = {
				min = 4,
				max = 8,
		...
		["Silifke-Incirlik Supply Line 8-9"] =  { 
			task = "Strike",
			priority = 6,
			picture = {"Silifke-Incirlik_Supply_Line_8-9"},
			attributes = {"Structure"},
			firepower = {
				min = 4,
				max = 8,
