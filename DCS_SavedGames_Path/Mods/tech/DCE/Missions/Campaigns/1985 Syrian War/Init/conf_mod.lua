...
mission_ini = {
	...
	max_skill_blue_attacker = "Excellent",	-- Average, Good, High, Excellent
	min_skill_blue_bomber = "Good",	-- Average, Good, High, Excellent
	max_skill_blue_bomber = "Excellent",	-- Average, Good, High, Excellent
	min_skill_blue_transport = "Average",	-- Average, Good, High, Excellent
	max_skill_blue_transport = "High",	-- Average, Good, High, Excellent
	min_skill_blue_recognition = "Good",	-- Average, Good, High, Excellent
	...
	max_skill_red_attacker = "Excellent",	-- Average, Good, High, Excellent
	min_skill_red_bomber = "Good",	-- Average, Good, High, Excellent
	max_skill_red_bomber = "Excellent",	-- Average, Good, High, Excellent
