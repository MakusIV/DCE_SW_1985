...
local function cnt_unit(t, name)
...
local function callsign(index, clsid, name)							return {  CLSID =  clsid; Index = name; ID = index;}end
...
local use_default_callsigns = nil
...
-- to new format
local function make(displayName, name,shortname,id, callsigns, ranks, awards, troops)
	local res = {};
	...
	res.WorldID 		= id;
	res.CallNames 		= callsigns or copyTable(defaultCallsigns);
...
country = {
	...
	add  = function(self, country, displayName, name, shortname, callsigns,ranks,awards,troops)
		local idx 			= self:next()
		self[country] 		= idx
		local new_country   = make(displayName,name,shortname,idx,callsigns,ranks,awards,troops)
...
country:add('LEBANON',_("Lebanon"), "Lebanon", "LEB",
  use_default_callsigns,
  use_default_ranks,
  {
    award('Commemorative Medal of Peace Operations', _('Commemorative Medal of Peace Operations'), 200,  'IT-01-Commemorative_Medal_of_Peace_Operations.png'),
...
country:add("AUSTRIA" ,_("Austria") , "Austria", "AUT", use_default_callsigns	,	use_default_ranks,	no_awards,
{
    squadron('Austrian Federal Army', _('Austrian Federal Army'),'Bundesheer.png'),
})

country:add("BELARUS" ,_("Belarus") , 		"Belarus"			, "BLR", use_default_callsigns	,	use_default_ranks,	no_awards,
{
...
country:add("BULGARIA",_("Bulgaria"), 		"Bulgaria"			, "BGR", use_default_callsigns	,	use_default_ranks,	no_awards,
{
    squadron('Bulgarian Air Force', _('Bulgarian Air Force'),'VVS.png'),
})

country:add("CHEZH_REPUBLIC",_("Czech Republic"),"Czech Republic"	, "CZE", use_default_callsigns	,	use_default_ranks,	no_awards,
{
...
-- China
country:add("CHINA", 		_("China"), 		"China"				, "CHN", copyTable(ru_Callsigns),	use_default_ranks,	
{
...
country:add("CROATIA", 		_("Croatia"), 		"Croatia"			, "HRV", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("EGYPT", 		_("Egypt"), 		"Egypt"				, "EGY", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("FINLAND", 		_("Finland"), 		"Finland"			, "FIN", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("GREECE", 		_("Greece"), 		"Greece"			, "GRC", use_default_callsigns	,	use_default_ranks,
-- as we cannot push greek symbols to _( ) function  ,  source commented
--[[
  {
    rank('Second lieutenant' , _('Ανθυποσμηναγός'), 0,   {0, 0, 64, 32}),
    rank('First lieutenant'	 , _('Υποσμηναγός')   , 15,  {0, 32, 64, 32}),
    rank('Captain'			 , _('Σμηναγός')	  , 30,  {0, 64, 64, 32}),
    rank('Major'			 , _('Επισμηναγός')   , 60,  {0, 96, 64, 32}),
    rank('Lieutenant colonel', _('Αντισμήναρχος') , 120, {0, 128, 64, 32}),
    rank('Colonel'			 , _('Σμήναρχος')     , 240, {0, 160, 64, 32}),
  },
--]] 
  {
    award('Medal for Outstanding Acts', _('Medal for Outstanding Acts'), 800,  'GR-01-Medal_for_Outstanding_Acts.png'), -- _('Μετάλλιο Εξαιρέτων Πράξεων')
    award('War Cross 3rd Class'       , _('War Cross 3rd Class'       ), 1200, 'GR-02-War_Cross_C_Class.png'),          -- _('Πολεμικός Σταυρός Γ Τάξεως')
    award('War Cross 2nd Class'       , _('War Cross 2nd Class'       ), 1600, 'GR-03-War_Cross_B_Class.png'),          -- _('Πολεμικός Σταυρός Β Τάξεως')
    award('Silver Medal for Valour'   , _('Silver Medal for Valour'   ), 2200, 'GR-04-Silver_Medal_for_Valour.png'),    -- _('Αργυρό Αριστείο Ανδρείας')
    award('Golden Medal for Valour'   , _('Golden Medal for Valour'   ), 2600, 'GR-05-Golden_Medal_for_Valour.png'),    -- _('Χρυσό Αριστείο Ανδρείας')
    award('Medal for Gallandry'       , _('Medal for Gallandry'       ), 3000, 'GR-06-Medal_for_Gallandry.png'),        -- _('Αριστείο Ανδραγαθίας')
  },
  {
    squadron('330 SQN HAF', 				_('330 SQN HAF'), '330sqn.png'),		-- _('330 ΜΟΙΡΑ'	),
  	squadron('331 SQN HAF', 				_('331 SQN HAF'), '331mpk.png'),       -- _('331 ΜΠΚ'		),
  	squadron('332 SQN HAF', 				_('332 SQN HAF'), '332mpk.png'),       -- _('332 ΜΠΚ'		),
  	squadron('335 SQN HAF', 				_('335 SQN HAF'), '335mb.png'),        -- _('335 MB'		),
  	squadron('336 SQN HAF', 				_('336 SQN HAF'), '336mb.png'),        -- _('336 MB'		),
  	squadron('337 SQN HAF', 				_('337 SQN HAF'), '337sqn.png'),       -- _('337 ΜΟΙΡΑ'	),
  	squadron('338 SQN HAF', 				_('338 SQN HAF'), '338mdb.png'),       -- _('338 ΜΔΒ'		),
  	squadron('339 SQN HAF', 				_('339 SQN HAF'), '339mpk.png'),       -- _('339 ΜΠΚ'		),
  	squadron('340 SQN HAF', 				_('340 SQN HAF'), '340sqn.png'),       -- _('340 ΜΟΙΡΑ'	),
  	squadron('341 SQN HAF', 				_('341 SQN HAF'), '341mpk.png'),       -- _('341 ΜΠΚ'		),
  	squadron('343 SQN HAF', 				_('343 SQN HAF'), '343m.png'),         -- _('343 ΜΟΙΡΑ'	),
  	squadron('343 STAR HAF',				_('343 STAR HAF'), 'star.png'),         -- _('343 STAR'	),
  	squadron('347 SQN HAF', 				_('347 SQN HAF'), '347sqn.png'),       -- _('347 ΜΟΙΡΑ'	),
  	squadron('348 SQN HAF', 				_('348 SQN HAF'), '348mta.png'),       -- _('348 ΜΤΑ'		),
  	squadron('356 SQN HAF', 				_('356 SQN HAF'), '356mtm.png'),       -- _('356 ΜΤΜ'		),
  	squadron('358 SQN HAF', 				_('358 SQN HAF'), '358sar.png'),       -- _('358 ΜΕΔ'		),
  	squadron('361 SQN HAF', 				_('361 SQN HAF'), '361mea.png'),       -- _('361 ΜΕΑ'		),
  	...
  	squadron('380 SQN HAF', 				_('380 SQN HAF'), '380sqn.png'),       -- _('380 ΑΣΕΠΕ'	),
  	squadron('384 SQN HAF', 				_('384 SQN HAF'), '384sar.png'),       -- _('384 ΜΕΔ'		),
  	squadron('1ST ATTACK HELICOPTER SQN', 	_('1ST ATTACK HELICOPTER SQN'), '1teep.png'),        -- _('1o ΤΕΕΠ'		),
  	squadron('2ND ATTACK HELICOPTER SQN', 	_('2ND ATTACK HELICOPTER SQN'), '2teep.png'),        -- _('2o ΤΕΕΠ'		),
  	squadron('2ND HELICOPTER SQN', 			_('2ND HELICOPTER SQN'), '2teas.png'),        -- _('2o ΤΕΑΣ'		),
  	squadron('4TH HELICOPTER SQN', 			_('4TH HELICOPTER SQN'), '4teas.png'),        -- _('4o ΤΕΑΣ'		),
  	squadron('ARMOUR TRAINING CENTER', 		_('ARMOUR TRAINING CENTER'), 'ket8.png'),         -- _('ΚΕΤΘ'		),
  	squadron('21ST ARMORED BRIGADE', 		_('21ST ARMORED BRIGADE'), '21tt.png'),         -- _('21 ΤΘΤ'		),
  	squadron('24TH ARMORED BRIGADE', 		_('24TH ARMORED BRIGADE'), '24tt.png'),         -- _('24 ΤΘΤ'		),
})
...
country:add("HUNGARY",		_("Hungary"),		"Hungary"			, "HUN", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("INDIA",		_("India"),			"India"				, "IND", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("IRAN",			_("Iran"),			"Iran"				, "IRN", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("IRAQ",			_("Iraq"),			"Iraq"				, "IRQ", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("JAPAN",		_("Japan"),			"Japan"				, "JPN", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("KAZAKHSTAN",	_("Kazakhstan"),	"Kazakhstan"		, "KAZ", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("NORTH_KOREA",	_("North Korea"),	"North Korea"		, "PRK", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("PAKISTAN",		_("Pakistan"),		"Pakistan"			, "PAK", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("POLAND",		_("Poland"),		"Poland"			, "POL", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("ROMANIA",		_("Romania"),		"Romania"			, "ROU", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("SAUDI_ARABIA",	_("Saudi Arabia"),	"Saudi Arabia"		, "SAU", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("SERBIA",		_("Serbia"),		"Serbia"			, "SRB", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("SLOVAKIA",		_("Slovakia"),		"Slovakia"			, "SVK", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("SOUTH_KOREA",	_("South Korea"),	"South Korea"		, "KOR", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("SWEDEN",		_("Sweden"),		"Sweden"			, "SWE", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("SYRIA",		_("Syria"),			"Syria"				, "SYR", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("LEBANON",		_("Lebanon"),	    "Lebanon"			, "LEB", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )


country:add("YEMEN",		_("Yemen"),			"Yemen"				, "YEM", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("VIETNAM",		_("Vietnam"),		"Vietnam"			, "VNM", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("VENEZUELA",	_("Venezuela"),		"Venezuela"			, "VEN", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("TUNISIA",		_("Tunisia"),		"Tunisia"			, "TUN", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("THAILAND",		_("Thailand"),		"Thailand"			, "THA", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("SUDAN",		_("Sudan"),			"Sudan"				, "SDN", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("PHILIPPINES",	_("Philippines"),	"Philippines"		, "PHL", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("MOROCCO",		_("Morocco"),		"Morocco"			, "MAR", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("MEXICO",		_("Mexico"),		"Mexico"			, "MEX", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("MALAYSIA",		_("Malaysia"),		"Malaysia"			, "MYS", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("LIBYA",		_("Libya"),			"Libya"				, "LBY", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("JORDAN",		_("Jordan"),		"Jordan"			, "JOR", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("INDONESIA",	_("Indonesia"),		"Indonesia"			, "IDN", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("HONDURAS",		_("Honduras"),		"Honduras"			, "HND", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("ETHIOPIA",		_("Ethiopia"),		"Ethiopia"			, "ETH", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("CHILE",		_("Chile"),			"Chile"				, "CHL", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
country:add("BRAZIL",		_("Brazil"),		"Brazil"			, "BRA", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons ) 
country:add("BAHRAIN",		_("Bahrain"),		"Bahrain"			, "BHR", use_default_callsigns	,	use_default_ranks,	no_awards, no_squadrons )
...
local function add_to_unit_list(t,name)
	local c =  cache[t]
	if 	c[name] == nil then 
	    cnt_unit(t,name)
		c[name] = true
...
local function merge_unit_list(src_list,target_list)
	...
	for i,o in ipairs (src_list) do
		add_to_unit_list(target_list,o.Name)
	end
end
