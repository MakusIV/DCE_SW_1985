...
db_loadouts = {
	...
	["C-101CC"] = {--
		...
		["Strike"] = {
			...
			["CAS Cluster Bombs, Belouga*2, AN-M3, Fuel*2"] = {
				role = "attacker",
				role_altitude = "normal",
				coalition = "blue",
				minscore = 0.0,
	...
	--[[
		...
		["B-1B"] = { --1986 BOH verifica payload
			["Strike"] = {
				["Strike TF AGM-154*12"] = { --1998 NO
					minscore = 0.3,
					support = {
						["Escort"] = true,
						["SEAD"] = false,
	...
	["Su-25"] = { --1981 -> OK <-
		...
		["Strike"] = {
			...
			["Pinpoint Strike SM R-60*2 Kh-25ML*4 Kh-29L"] = {
				minscore = 0.3,
					support = {
						["Escort"] = true,
						["SEAD"] = true,
	...
	["Mi-24P"] = {--1980 (primo volo) (entrata in servizio) -> OK <-
		...
		["Strike"] = {			
			...
			["CAS Cluster Bombs RBK-250 9M114*4"] = {
				minscore = 0.0,
				attributes = {"soft"},
				weaponType = "Rockets",
				expend = "All",
	...
	["MiG-19P"] = {--1953 (primo volo) 1955 (entrata in servizio) Syria
		["Intercept"] = {
	...
	["Tu-142"] = {--1975 (primo volo) 1980 (entrata in servizio) ha solo il Kh-35 del 2003
		["Anti-ship Strike"] = {
