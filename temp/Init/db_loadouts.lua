...
db_loadouts = {
	...
	["SH-60B"] = {--? (primo volo) 1984 (entrata in servizio) --verifica e/o cambia payload
		["CAP"] = {
			["ASW Patrol"] = {
				attributes = {"Seahawk"},
				day = true,
	...
	["B-1B"] = { --1974 (primo volo) 1986 (entrata in servizio)  --verifica e/o cambia payload
		["Strike"] = {
    ...
    ["Tu-142"] = {--1975 (primo volo) 1980 (entrata in servizio) 
		["Anti-ship Strike"] = {
