...
mission_ini = {
	...
	Keep_USNdeckCrew = true,					-- (default : false), false = supprime US Navy deck crew dans la g�n�ration de mission (Ceci n'installe/desinstalle pas le MOD USN) Miguel Modification M23
