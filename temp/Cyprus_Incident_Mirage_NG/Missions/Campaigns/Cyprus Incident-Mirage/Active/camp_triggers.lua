camp_triggers = {
	...
	['Turkish involvement'] = {
		...
		['action'] = {
			...
			[2] = 'Action.AirUnitActive("2nd-2 KHA", true)',
			[3] = 'Action.TargetActive("Airlift Ercan Airbase 2", true)',
			[1] = 'Action.AirUnitActive("2nd KHA", true)',
	...
	['North Cyprus Force First Victory - Greece involvement'] = {
		...
		['once'] = true,
		['action'] = {
			[1] = 'Action.TargetActive("Airlift Paphos Airbase 2", true)',
			[2] = 'Action.TargetActive("Airlift Paphos Airbase 3", true)',
			[4] = 'Action.SetCampFlag(802, Return.Mission())',
			[3] = 'Action.Text("North Cyprus columns are circling Nicosia and will soon be able to capture the city. Greece can t tolerate that and decided to help Cyprus. Soon more Ground forces will be projected to protect Cyprus")',
		},
		['active'] = true,
	},
	...
	['North Cyprus Force 1 initial positions'] = {
		...
		['once'] = true,
		['action'] = {
			[7] = 'Action.TemplateActive("Cyprus Border Force 2 T1.stm")',
			[1] = 'Action.TemplateActive("North Cyprus Force 1 T1.stm")',
			[2] = 'Action.TargetActive("North Cyprus Force 1", true)',
			[4] = 'Action.AirUnitActive("134.Filo", true)',
			[8] = 'Action.TargetActive("Cyprus Border Force 2", true)',
			[9] = 'Action.AddImage("Newspaper_FirstNight_blue.jpg", "blue")',
			[5] = 'Action.TargetActive("CAP-1-Turkish", true)',
			[3] = 'Action.AirUnitActive("111.Filo", true)',
			[6] = 'Action.Text("North Cyprus columns crossed the No man s land and are coming from the far South west of Nicosia. Turkish air force is flying over Cyprus and seems to try to maintain air superiority")',
		},
		['active'] = false,
	},
	...
	['Greek EC 331 initial positions'] = {
		...
		['once'] = true,
		['action'] = {
			[6] = 'Action.Text("North Cyprus columns crossed the No man s land and are coming from the far South west of Nicosia. Greek squadron will have to maintain air superiority against Turkish Phantom and Tigers while trying to help Cyprus shoppers to cripple North Cyprus columns")',
			[2] = 'Action.TargetActive("Paphos Airbase Alert", true)',
			[3] = 'Action.TargetActive("Paphos Airbase Alert 2", true)',
			[1] = 'Action.AirUnitActive("EC 331", true)',
			[4] = 'Action.TargetActive("Paphos Airbase Alert 3", true)',
			[5] = 'Action.TargetActive("CAP-1-Greek", true)',
		},
		['active'] = false,
	},
