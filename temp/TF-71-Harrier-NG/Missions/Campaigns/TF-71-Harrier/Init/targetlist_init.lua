targetlist = {
	["blue"] = {
		...
		-- ["CVN-72 Abraham Lincoln Interception"] = {
			-- task = "Intercept",
			-- priority = 10,
			-- attributes = {},
			-- firepower = {
		...
		-- ["Lincoln SAR"] = {
			...
			-- firepower = {
				...
				-- max = 1,
			-- },
			-- slaved = {"CVN-72 Abraham Lincoln", 45, 200},
			-- radius = 1,
			-- text = "",
		-- },
		["Battle Group CAP 2"] = {
		...
		----- CVN-71 Theodore Roosevelt Support -----
		-- ["Battle Group CAP"] = {
			-- task = "CAP",
			-- priority = 1,
			-- attributes = {},
			-- firepower = {
				...
				-- max = 2,
			-- },
			-- slaved = {"CVN-71 Theodore Roosevelt", 080, 92600},
			-- radius = 111000,
			-- text = "",
		-- },
		-- ["Battle Group AEW"] = {
			...
			-- firepower = {
				...
				-- max = 1,
			-- },
			-- slaved = {"CVN-71 Theodore Roosevelt", 045, 55500},
			-- text = "",
		-- },
		-- ["Mission Support Tanker 1"] = {
			...
			-- firepower = {
				...
				-- max = 1,
			-- },
			-- slaved = {"CVN-71 Theodore Roosevelt", 080, 83300},
			-- text = "",
		-- },
		-- ["Mission Support Tanker 2"] = {
			...
			-- firepower = {
				...
				-- max = 1,
			-- },
			-- slaved = {"CVN-71 Theodore Roosevelt", 090, 83300},
			-- text = "",
		-- },		
		-- ["Recovery Tanker 1"] = {
			-- task = "Refueling",
			...
			-- firepower = {
				...
				-- max = 1,
			-- },
			-- slaved = {"CVN-71 Theodore Roosevelt", 080, 10000},
			-- text = "",
		-- },
		-- ["Recovery Tanker 2"] = {
			-- task = "Refueling",
			...
			-- firepower = {
				...
				-- max = 1,
			-- },
			-- slaved = {"CVN-71 Theodore Roosevelt", 090, 10000},
			-- text = "",
		-- },		
		-- ["Outer ASW Patrol"] = {
			-- task = "CAP",
			...
			-- firepower = {
				...
				-- max = 1,
			-- },
			-- slaved = {"CVN-71 Theodore Roosevelt", 075, 92600},
			-- radius = 0,
			-- text = "",
		-- },
		-- ["Inner ASW Patrol"] = {
			...
			-- firepower = {
				...
				-- max = 1,
			-- },
			-- slaved = {"CVN-71 Theodore Roosevelt", 045, 27700},
			-- radius = 0,
			-- text = "",
		-- },		
	},
