...
camp = {
	title = "TF-71-Harrier",		--Title of campaign (name of missions)
	version = "V5.0",
	...
	weather = {						--campaign weather
		pHigh = 40,				--probability of high pressure weather system
		pLow = 60,					--probability of low pressure weather system
		refTemp = 15,				--average day max temperature
	},
